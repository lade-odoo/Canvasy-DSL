...
/** @constructor */
function $c_Lcanvasy_Canvasy() {
  $c_O.call(this);
  this.canvas$1 = null;
  this.shapes$1 = null;
  this.context$1 = null
}
$c_Lcanvasy_Canvasy.prototype = new $h_O();
$c_Lcanvasy_Canvasy.prototype.constructor = $c_Lcanvasy_Canvasy;
/** @constructor */
function $h_Lcanvasy_Canvasy() {
  /*<skip>*/
}
$h_Lcanvasy_Canvasy.prototype = $c_Lcanvasy_Canvasy.prototype;
$c_Lcanvasy_Canvasy.prototype.init___Lorg_scalajs_dom_raw_HTMLCanvasElement__scm_ListBuffer = (function(canvas, shapes) {
  this.canvas$1 = canvas;
  this.shapes$1 = shapes;
  this.context$1 = canvas.getContext("2d");
  return this
});
$c_Lcanvasy_Canvasy.prototype.draw__V = (function() {
  this.context$1.beginPath();
  var this$1 = this.shapes$1;
  var this$2 = this$1.scala$collection$mutable$ListBuffer$$start$6;
  var these = this$2;
  while ((!these.isEmpty__Z())) {
    var arg1 = these.head__O();
    var x$1 = $as_Lcanvasy_shapes_Shape(arg1);
    x$1.draw__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V(this.context$1);
    var this$3 = these;
    these = this$3.tail__sci_List()
  };
  this.context$1.stroke()
});
$c_Lcanvasy_Canvasy.prototype.$$plus$eq__ALcanvasy_shapes_Shape__Lcanvasy_Canvasy = (function(added) {
  this.shapes$1.$$plus$plus$eq__sc_TraversableOnce__scm_ListBuffer(new $c_scm_ArrayOps$ofRef().init___AO(added));
  return this
});
var $d_Lcanvasy_Canvasy = new $TypeData().initClass({
  Lcanvasy_Canvasy: 0
}, false, "canvasy.Canvasy", {
  Lcanvasy_Canvasy: 1,
  O: 1
});
$c_Lcanvasy_Canvasy.prototype.$classData = $d_Lcanvasy_Canvasy;
/** @constructor */
function $c_Lcanvasy_shapes_Shape() {
  $c_O.call(this);
  this.x$1 = 0;
  this.y$1 = 0
}
$c_Lcanvasy_shapes_Shape.prototype = new $h_O();
$c_Lcanvasy_shapes_Shape.prototype.constructor = $c_Lcanvasy_shapes_Shape;
/** @constructor */
function $h_Lcanvasy_shapes_Shape() {
  /*<skip>*/
}
$h_Lcanvasy_shapes_Shape.prototype = $c_Lcanvasy_shapes_Shape.prototype;
$c_Lcanvasy_shapes_Shape.prototype.init___I__I = (function(x, y) {
  this.x$1 = x;
  this.y$1 = y;
  return this
});
function $is_Lcanvasy_shapes_Shape(obj) {
  return (!(!((obj && obj.$classData) && obj.$classData.ancestors.Lcanvasy_shapes_Shape)))
}
function $as_Lcanvasy_shapes_Shape(obj) {
  return (($is_Lcanvasy_shapes_Shape(obj) || (obj === null)) ? obj : $throwClassCastException(obj, "canvasy.shapes.Shape"))
}
function $isArrayOf_Lcanvasy_shapes_Shape(obj, depth) {
  return (!(!(((obj && obj.$classData) && (obj.$classData.arrayDepth === depth)) && obj.$classData.arrayBase.ancestors.Lcanvasy_shapes_Shape)))
}
function $asArrayOf_Lcanvasy_shapes_Shape(obj, depth) {
  return (($isArrayOf_Lcanvasy_shapes_Shape(obj, depth) || (obj === null)) ? obj : $throwArrayCastException(obj, "Lcanvasy.shapes.Shape;", depth))
}
/** @constructor */
...
/** @constructor */
function $c_Ltutorial_webapp_WebApp$() {
  $c_O.call(this)
}
$c_Ltutorial_webapp_WebApp$.prototype = new $h_O();
$c_Ltutorial_webapp_WebApp$.prototype.constructor = $c_Ltutorial_webapp_WebApp$;
/** @constructor */
function $h_Ltutorial_webapp_WebApp$() {
  /*<skip>*/
}
$h_Ltutorial_webapp_WebApp$.prototype = $c_Ltutorial_webapp_WebApp$.prototype;
$c_Ltutorial_webapp_WebApp$.prototype.init___ = (function() {
  return this
});
$c_Ltutorial_webapp_WebApp$.prototype.dslDemo__Lorg_scalajs_dom_raw_HTMLCanvasElement__V = (function(canvas) {
  var canvasy = new $c_Lcanvasy_Canvasy().init___Lorg_scalajs_dom_raw_HTMLCanvasElement__scm_ListBuffer(canvas, new $c_scm_ListBuffer().init___());
  var elems$2 = null;
  elems$2 = [];
  var i = 0;
  while ((i < 4)) {
    var elem = new $c_Lcanvasy_shapes_Circle().init___D__I__I(50.0, 0, 0);
    elems$2.push(elem);
    i = ((1 + i) | 0)
  };
  var circles = $makeNativeArrayWrapper($d_Lcanvasy_shapes_Circle.getArrayOf(), elems$2);
  var elems$2$1 = null;
  elems$2$1 = [];
  var i$1 = 0;
  while ((i$1 < 2)) {
    var arg1 = i$1;
    var elem$1 = new $c_Lcanvasy_shapes_Rectangle().init___D__D__I__I($imul(50, arg1), $imul(50, arg1), 50, 100);
    elems$2$1.push(elem$1);
    i$1 = ((1 + i$1) | 0)
  };
  var rectangles = $makeNativeArrayWrapper($d_Lcanvasy_shapes_Rectangle.getArrayOf(), elems$2$1);
  canvasy.$$plus$eq__ALcanvasy_shapes_Shape__Lcanvasy_Canvasy(circles);
  canvasy.$$plus$eq__ALcanvasy_shapes_Shape__Lcanvasy_Canvasy(rectangles);
  canvasy.draw__V()
});
$c_Ltutorial_webapp_WebApp$.prototype.main__AT__V = (function(args) {
  ...
  canvas.width = 300;
  canvas.height = 300;
  this.dslDemo__Lorg_scalajs_dom_raw_HTMLCanvasElement__V(canvas)
});
var $d_Ltutorial_webapp_WebApp$ = new $TypeData().initClass({
  Ltutorial_webapp_WebApp$: 0
}, false, "tutorial.webapp.WebApp$", {
  Ltutorial_webapp_WebApp$: 1,
  O: 1
});
$c_Ltutorial_webapp_WebApp$.prototype.$classData = $d_Ltutorial_webapp_WebApp$;
var $n_Ltutorial_webapp_WebApp$ = (void 0);
function $m_Ltutorial_webapp_WebApp$() {
  if ((!$n_Ltutorial_webapp_WebApp$)) {
    $n_Ltutorial_webapp_WebApp$ = new $c_Ltutorial_webapp_WebApp$().init___()
  };
  return $n_Ltutorial_webapp_WebApp$
}
/** @constructor */
function $c_jl_Class() {
  $c_O.call(this);
...
/** @constructor */
function $c_Lcanvasy_shapes_Circle() {
  $c_Lcanvasy_shapes_Shape.call(this);
  this.radius$2 = 0.0;
  this.x$2 = 0;
  this.y$2 = 0
}
$c_Lcanvasy_shapes_Circle.prototype = new $h_Lcanvasy_shapes_Shape();
$c_Lcanvasy_shapes_Circle.prototype.constructor = $c_Lcanvasy_shapes_Circle;
/** @constructor */
function $h_Lcanvasy_shapes_Circle() {
  /*<skip>*/
}
$h_Lcanvasy_shapes_Circle.prototype = $c_Lcanvasy_shapes_Circle.prototype;
$c_Lcanvasy_shapes_Circle.prototype.draw__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V = (function(context) {
  context.arc(this.x$2, this.y$2, this.radius$2, 0.0, 6.28)
});
$c_Lcanvasy_shapes_Circle.prototype.init___D__I__I = (function(radius, x, y) {
  this.radius$2 = radius;
  this.x$2 = x;
  this.y$2 = y;
  $c_Lcanvasy_shapes_Shape.prototype.init___I__I.call(this, x, y);
  return this
});
var $d_Lcanvasy_shapes_Circle = new $TypeData().initClass({
  Lcanvasy_shapes_Circle: 0
}, false, "canvasy.shapes.Circle", {
  Lcanvasy_shapes_Circle: 1,
  Lcanvasy_shapes_Shape: 1,
  O: 1
});
$c_Lcanvasy_shapes_Circle.prototype.$classData = $d_Lcanvasy_shapes_Circle;
/** @constructor */
function $c_Lcanvasy_shapes_Rectangle() {
  $c_Lcanvasy_shapes_Shape.call(this);
  this.width$2 = 0.0;
  this.height$2 = 0.0;
  this.x$2 = 0;
...
$c_Lcanvasy_shapes_Rectangle.prototype = new $h_Lcanvasy_shapes_Shape();
$c_Lcanvasy_shapes_Rectangle.prototype.constructor = $c_Lcanvasy_shapes_Rectangle;
/** @constructor */
function $h_Lcanvasy_shapes_Rectangle() {
  /*<skip>*/
}
$h_Lcanvasy_shapes_Rectangle.prototype = $c_Lcanvasy_shapes_Rectangle.prototype;
$c_Lcanvasy_shapes_Rectangle.prototype.draw__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__V = (function(context) {
  context.moveTo(this.x$2, this.y$2);
  context.lineTo(this.x$2, (this.y$2 + this.height$2));
  context.lineTo((this.x$2 + this.width$2), (this.y$2 + this.height$2));
  context.lineTo((this.x$2 + this.width$2), this.y$2);
  context.lineTo(this.x$2, this.y$2)
});
$c_Lcanvasy_shapes_Rectangle.prototype.init___D__D__I__I = (function(width, height, x, y) {
  this.width$2 = width;
...
var $d_Lcanvasy_shapes_Rectangle = new $TypeData().initClass({
  Lcanvasy_shapes_Rectangle: 0
}, false, "canvasy.shapes.Rectangle", {
  Lcanvasy_shapes_Rectangle: 1,
  Lcanvasy_shapes_Shape: 1,
  O: 1
});
$c_Lcanvasy_shapes_Rectangle.prototype.$classData = $d_Lcanvasy_shapes_Rectangle;
/** @constructor */
...
$c_scm_ArrayBuffer.prototype.$classData = $d_scm_ArrayBuffer;
$m_Ltutorial_webapp_WebApp$().main__AT__V($makeNativeArrayWrapper($d_T.getArrayOf(), []));
}).call(this);
